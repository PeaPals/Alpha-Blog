                    ...
                    {(
                        signedIn && <>
                            <li className="nav-item dropdown">
                                <a className="nav-link dropdown-toggle" id="home-nav-link" href="#" role="button" data-bs-toggle="dropdown" aria-expanded="false">Articles</a>
                            ...
                            <li className="nav-item dropdown">
                                <a className="nav-link dropdown-toggle" id="home-nav-link" href="#" role="button" data-bs-toggle="dropdown" aria-expanded="false">Categories</a>
                                <ul className="dropdown-menu">
                            ...
                            <li className="nav-item dropdown">
                                ...
                                <a className="nav-link dropdown-toggle" id="home-nav-link" href="#" role="button" data-bs-toggle="dropdown" aria-expanded="false">username</a>
                                <ul className="dropdown-menu">
